...
constexpr static wstring_view_t kDUITabControlClassName = L"SysTabControl32";
constexpr static wstring_view_t kDUIHeaderControlClassName = L"SysHeader32";
constexpr static wstring_view_t kDUIListControlClassName = L"libPPUI:CListControl";
